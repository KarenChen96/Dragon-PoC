 ...
 *            {@link EmcDemoMsgEvent#getPayload()} retrieved from the "data" JSON
 *            property.
 *
 * @see <a href=
 ...
 */
@JsonTypeInfo(use = Id.NAME, include = As.PROPERTY, property = EmcDemoMsgEvent.JSON_TYPE_ID_SOURCE_PROPERTY)
@JsonSubTypes({
	@JsonSubTypes.Type(value = EmcDemoProjectEvent.class, name = EmcDemoProjectEvent.JSON_TYPE_ID_CREATED),
	@JsonSubTypes.Type(value = EmcDemoProjectEvent.class, name = EmcDemoProjectEvent.JSON_TYPE_ID_CHANGED)
})
class EmcDemoMsgEvent<T> {
